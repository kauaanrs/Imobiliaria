    ...
    <div class="container py-3">
        ...
        <form method="post" action="{{ route('clientes.update', $cliente) }}">
            ...
            <div class="mb-3">
                ...
                <input type="date" id="data_nascimento" name="data_nascimento" class="form-control" value="{{ old('data_nascimento', $cliente->data_nascimento->format('Y-m-d')) }}" required>
            </div>
            <div class="mb-3">
                <label for="telefone" class="form-label">Telefone</label>
                <input type="text" id="telefone" name="telefone" class="form-control" value="{{ old('telefone', $cliente->telefone) }}" required>
            </div>
            <div class="mb-3">
